...
export const metadata: Metadata = {
  title: "Photo Gallery | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "Browse photos of balcony safety nets, bird proofing nets, invisible window grills, and ceiling cloth hangers installed by Aegis Nets in Chennai.",
  alternates: {
    canonical: "/gallery",
  },
};
...
export default function GalleryPage() {
  ...
  const collectionSchema = {
    ...
    "@type": "CollectionPage",
    "name": "Photo Gallery | Aegis Nets",
    "url": "https://www.aegisnets.in/gallery",
    "description": "Photo archives of completed netting and invisible grill setups by Aegis in Chennai.",
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-12 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Browse through real photographs of Aegis Nets installations. Filters include Safety Netting types, Invisible Grills, Hangers, raw materials, and team operations.
          </p>
        </div>
