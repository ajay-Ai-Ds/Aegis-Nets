...
export const metadata: Metadata = {
  title: "Contact Us | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "Get in touch with Aegis Nets for free site measurement and instant safety net or invisible grill quotes in Chennai. Call +91 73959 57105 or WhatsApp us today.",
  alternates: {
    canonical: "/contact",
  },
};
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <a href="tel:+917395957105" className="text-sm font-bold text-slate-700 hover:text-accent-orange transition-colors">
                    +91 73959 57105 (Primary)
                  </a>
                  <a href="tel:+919360915505" className="text-sm font-bold text-slate-700 hover:text-accent-orange transition-colors">
                    +91 93609 15505 (Secondary)
                  </a>
                </div>
              </div>
