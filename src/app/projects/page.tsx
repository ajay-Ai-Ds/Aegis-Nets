...
export const metadata: Metadata = {
  title: "Completed Projects | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "View completed safety net and invisible grill installation projects by Aegis Nets across gated communities, apartments, and villas in Chennai.",
  alternates: {
    canonical: "/projects",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl mb-12 flex flex-col gap-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
            Review case profiles of completed safety netting systems and invisible grills installed by Aegis Nets in residential blocks and factories across Chennai.
          </p>
        </div>
