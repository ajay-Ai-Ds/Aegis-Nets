...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!areaDetail) {
    return {
      title: "Area Not Found | Aegis Nets",
    };
  }

  return {
    title: `Safety Nets & Invisible Grills in ${areaDetail.name}, Chennai | Aegis`,
    description: `Aegis Nets offers professional balcony safety nets, kid safety grids, and rustproof invisible grills in ${areaDetail.name}, Chennai. Free measurements.`,
    alternates: {
    ...
    openGraph: {
      title: `Safety Nets & Invisible Grills in ${areaDetail.name}, Chennai | Aegis`,
      description: `Aegis Nets offers professional balcony safety nets, kid safety grids, and rustproof invisible grills in ${areaDetail.name}, Chennai. Free measurements.`,
      url: `https://www.aegisnets.in/areas/${resolvedParams.area}`,
      images: [
        {
  ...
  const localFAQs = [
    {
      ...
      answer: `No. Aegis Nets offers 100% free site visits, catalog displays, and measurements in ${areaDetail.name} and surrounding Chennai locations without any payment commitments.`,
    },
    {
    ...
    {
      question: `Can Aegis invisible grills handle the weather in ${areaDetail.name}?`,
      answer: `Yes. Our invisible grills utilize marine-grade SS316 stainless steel wires wrapped in a clear nylon protective casing. They are highly rustproof and resist Chennai's extreme heat and coastal sea moisture.`,
    },
  ];
        ...
        <div className="bg-slate-900 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden mb-16 shadow-md">
          ...
          <div className="relative z-10 max-w-2xl flex flex-col gap-5 items-start">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              Premium protective netting, bird exclusion structures, and space-saving hangers installed by certified professionals in {areaDetail.name}, Chennai.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 max-w-xl flex flex-col gap-2">
              ...
              <p className="text-xs text-slate-200 leading-relaxed font-semibold">
                Aegis Nets is the leading safety net and invisible grill installer in {areaDetail.name}, Chennai. We provide child balcony shields, bite-proof pet nets, and rustproof SS316 wire grills custom anchored with free measurements.
              </p>
            </div>
