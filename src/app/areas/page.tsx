...
export const metadata: Metadata = {
  title: "Areas We Serve | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "Aegis Nets provides fast doorstep site measurement and safety net installation services across Anna Nagar, Adyar, Velachery, OMR, Porur, and all Chennai neighborhoods.",
  alternates: {
    canonical: "/areas",
  },
};
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs text-center flex flex-col gap-4">
              ...
              <p className="text-slate-500 text-xs leading-relaxed">
                Aegis Nets offers 100% free site visits, measurements, and catalog presentations across all listed locations.
              </p>
              <a
