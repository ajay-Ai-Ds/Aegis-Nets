...
export const metadata: Metadata = {
  title: "Search Services, Areas & Blogs | Aegis Nets",
  description:
    "Search across Aegis Nets balcony safety nets, invisible steel wire grills, laundry hangers, case study projects, and coverage areas in Chennai.",
  alternates: {
    canonical: "/search",
  },
};
    ...
    <div className="bg-slate-50 min-h-screen py-12">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left mb-10 flex flex-col gap-2">
          <span className="text-xs font-bold uppercase tracking-widest text-accent-orange bg-orange-50 px-3 py-1 rounded-full inline-block self-start">
            Fuzzy Finder
          </span>
