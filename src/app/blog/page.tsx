...
export const metadata: Metadata = {
  title: "Safety & Childproofing Blog | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "Read expert tips on balcony safety netting, invisible grill price guides, bird control solutions, and apartment childproofing from Aegis Nets Chennai.",
  alternates: {
    canonical: "/blog",
  },
};
...
export default async function BlogPage() {
  ...
  const collectionSchema = {
    ...
    "@type": "CollectionPage",
    "name": "Safety and Home Childproofing Blog | Aegis",
    "url": "https://www.aegisnets.in/blog",
