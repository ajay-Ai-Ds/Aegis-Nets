...
export const metadata: Metadata = {
  title: "About Us | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "Learn about Aegis Nets, Chennai's trusted safety netting and invisible grill installation specialists with 10+ years experience in child proofing and bird control.",
  alternates: {
    canonical: "/about",
  },
};
          ...
          <div className="lg:col-span-8 flex flex-col gap-8 text-left">
            <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-xs flex flex-col gap-5">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Aegis Nets was established in Chennai to address critical safety gaps in high-rise living. With the rapid development of residential townships along OMR, Velachery, and ECR, open balconies and low railings have become active hazards for children and household pets.
              </p>
              <p className="text-slate-500 text-sm leading-relaxed">
