...
export const metadata = {
  title: "Our Services | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "Explore Aegis Nets' comprehensive range of safety netting solutions, SS316 marine-grade invisible grills, and space-saving ceiling cloth drying hangers in Chennai.",
  alternates: {
    canonical: "/services",
  },
};
