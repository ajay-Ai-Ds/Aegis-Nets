...
export const metadata = {
  title: "Balcony & Safety Nets | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "High-tensile UV-treated balcony safety nets, pigeon nets, child protection nets, and pet safety nets installed by Aegis Nets in Chennai.",
  alternates: {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "Safety Nets",
        "item": "https://www.aegisnets.in/services/safety-nets",
      },
    ],
  };
