...
export const metadata = {
  title: "Invisible Grills | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "Stainless steel 316 marine-grade invisible grills for balconies, windows, and staircases by Aegis Nets Chennai. Unobstructed view with max security.",
  alternates: {
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Home",
        "item": "https://www.aegisnets.in",
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Services",
        "item": "https://www.aegisnets.in/services",
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "Invisible Grills",
        "item": "https://www.aegisnets.in/services/invisible-grills",
      },
    ],
  };
