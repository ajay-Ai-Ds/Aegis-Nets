...
export const metadata = {
  title: "Ceiling Cloth Hangers | Aegis Nets - Safety Nets & Invisible Grills Chennai",
  description: "Rust-proof ceiling-mounted pulley cloth drying hangers installed in balconies and utility spaces by Aegis Nets Chennai.",
  alternates: {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "Cloth Hangers",
        "item": "https://www.aegisnets.in/services/cloth-hangers",
      },
    ],
  };
