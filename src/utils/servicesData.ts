...
function generateFAQsForService(serviceName: string, category: string): FAQItem[] {
  return [
    ...
    },
    {
      ...
      answer: "Content Required From Client. Aegis Nets offers warranties on specific netting grades and stainless steel cable grills. Exact warranty terms, duration, and certificates will be shared during site inspection.",
    },
    {
