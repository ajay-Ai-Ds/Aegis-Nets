  ...
  return [
    {
      ...
      answer: "Pricing is calculated based on total square footage, selected material specification (mesh thickness/wire grade), installation height, and anchoring structure. Contact our team for a 100% free on-site measurement and exact transparent quotation.",
    },
    {
      question: `Do you provide a warranty on ${serviceName}?`,
      answer: "Yes. Aegis Nets provides comprehensive warranty protection (3 to 5 years depending on material selection) on HDPE copolymer safety nets and SS316 marine-grade steel invisible grills. Warranty certificates are provided upon installation.",
    },
    {
    ...
    },
    {
      ...
      answer: `Yes, all Aegis Nets field technicians are trained in safety harness usage and high-rise installation guidelines. They are fully insured and handle high-floor setups professionally.`,
    },
    {
    ...
    {
      question: `How do we contact Aegis Nets for booking?`,
      answer: "You can book a free measurement session by calling us directly at +91 73959 57105, sending a message on WhatsApp, or submitting our contact request form.",
    },
  ];
}
...
export const servicesData: Record<string, ServiceDetail> = {
  ...
  "balcony-safety-nets": {
    ...
    title: "Premium Balcony Safety Nets Installation in Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    benefits: ["Child Safety Protection", "Pet Balcony Safety", "UV-Stabilized HDPE Mesh", "Rustproof Steel Hooks", "Clear Ventilation Flow", "5+ Years Lifespan Guarantee"],
    specsTable: [
      { label: "Material", value: "HDPE Copolymer Nylon" },
      { label: "Thickness", value: "0.8mm to 2.5mm" },
      { label: "Strength (Break Load)", value: "High Impact (> 150 kg)" },
      { label: "Durability", value: "5+ Years (UV-Stabilized)" },
  ...
  "children-safety-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Toddler & Children Fall Protection Nets Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    specsTable: [
      ...
      { label: "Strength (Break Load)", value: "High Impact Shock Resistance (> 180 kg)" },
      { label: "Durability", value: "5+ Years (Weatherproof)" },
      { label: "UV Resistance", value: "High (UV-Stabilized)" },
  ...
  "pet-safety-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Cat & Dog Balcony Protection Nets Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Pet Safety Nets create a secure boundary around balconies and windows, preventing dogs, cats, and birds from falling or escaping. Crafted with fine, claws-safe mesh, they are highly bite-resistant and firmly anchored.",
    ...
    specsTable: [
      ...
      { label: "Strength (Break Load)", value: "Claw & Bite Proof (> 120 kg)" },
      { label: "Durability", value: "5+ Years (UV-Stabilized)" },
      { label: "UV Resistance", value: "High (UV-Stabilized)" },
      { label: "Rust Resistance", value: "Not Applicable" },
  ...
  "pigeon-safety-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Transparent Pigeon Exclusion Nets Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    specsTable: [
      ...
      { label: "Strength (Break Load)", value: "Pigeon Exclusion Grade (> 90 kg)" },
      { label: "Durability", value: "5+ Years (Translucent Mesh)" },
      { label: "UV Resistance", value: "High (UV-Stabilized)" },
      { label: "Rust Resistance", value: "Not Applicable" },
  ...
  "sports-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Cricket Practice & Sports Ground Nets Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    specsTable: [
      ...
      { label: "Strength (Break Load)", value: "High Ball Strike Impact (> 250 kg)" },
      { label: "Durability", value: "5+ Years (Braided Cord)" },
      { label: "UV Resistance", value: "High (UV-Stabilized)" },
      { label: "Rust Resistance", value: "Not Applicable" },
  ...
  "construction-safety-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Industrial Fall & Debris Containment Nets Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Construction Safety Nets are heavy-duty industrial mesh borders designed to prevent work-site falls. Conforming to site safety codes, they act as active protection layers on high-rise constructions.",
    ...
    specsTable: [
      ...
      { label: "Strength (Break Load)", value: "Heavy Industrial Catch Load (> 500 kg)" },
      { label: "Durability", value: "Heavy Site Use (Weatherproof)" },
  ...
  "duct-area-safety-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Apartment Duct & Open Ventilation Shaft Nets Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Duct Area Safety Nets prevent pigeons and falling household waste from building up in open building shafts. Anchored across multi-story ducts, they optimize hygiene while allowing ventilation.",
    ...
    specsTable: [
      ...
      { label: "Thickness", value: "1.0mm to 2.5mm" },
      { label: "Strength (Break Load)", value: "High Tensile (> 120 kg)" },
      { label: "Durability", value: "5+ Years (UV-Stabilized)" },
      { label: "UV Resistance", value: "High (UV-Stabilized)" },
      { label: "Rust Resistance", value: "Not Applicable" },
  ...
  "monkey-safety-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Thick Steel-Reinforced Monkey Exclusion Nets Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Monkey Safety Nets provide animal exclusion using steel-core wire reinforced meshes. Strongly anchored to withstand pulling and chewing forces, they keep wild monkeys out of balconies.",
    ...
    specsTable: [
      ...
      { label: "Strength (Break Load)", value: "Steel Core Reinforced (> 350 kg)" },
      { label: "Durability", value: "5+ Years (Chew-Proof)" },
      { label: "UV Resistance", value: "High (UV-Stabilized)" },
  ...
  "cricket-practice-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Cricket Practice Nets Installation in Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    specsTable: [
      ...
      { label: "Strength (Break Load)", value: "Heavy Ball Strike Resistance (> 300 kg)" },
      { label: "Durability", value: "5+ Years (Braided Twine)" },
      { label: "UV Resistance", value: "High (UV-Stabilized)" },
  ...
  "balcony-invisible-grills": {
    ...
    title: "Balcony Invisible Grills Installation Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Balcony Invisible Grills feature high-strength SS316 steel wires wrapped in protective nylon coatings. They replace heavy iron grids to secure balconies for children and pets while preserving unobstructed view layouts.",
    ...
    specsTable: [
      ...
      { label: "Strength (Tension Limit)", value: "High Tensile (400+ kg Break Load)" },
      { label: "Durability", value: "10+ Years (Anti-Rust SS316)" },
  ...
  "window-invisible-grills": {
    ...
    category: "invisible-grills",
    categoryName: "Invisible Grills",
    title: "Aesthetic Window Invisible Grills Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Window Invisible Grills offer safety without dark prison-like bars. Utilizing thin-profile SS316 wires clamped in aluminum anchor tracks, they optimize lighting and air circulation.",
    ...
    specsTable: [
      { label: "Material Core", value: "SS316 Stainless Steel" },
      { label: "Thickness", value: "2.0mm to 2.5mm" },
      { label: "Strength (Break Load)", value: "High Tensile (400+ kg Break Load)" },
      { label: "Durability", value: "10+ Years (Anti-Rust SS316)" },
  ...
  "staircase-invisible-grills": {
    ...
    category: "invisible-grills",
    categoryName: "Invisible Grills",
    title: "Interior Staircase Handrail Invisible Grills Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Staircase Invisible Grills secure stair railings using sleek vertical SS316 wires. Providing high tension safety for children, they blend seamlessly into premium modern architectural interiors.",
  ...
  "ceiling-cloth-hangers": {
    ...
    title: "Pulley-operated Ceiling Cloth drying Hangers Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Ceiling Cloth Hangers maximize balcony space using a dual-pipe pulley system. Crafted with rust-free stainless steel rods and braided nylon ropes, they lift wet laundry out of sight with ease.",
    ...
    specsTable: [
      ...
      { label: "Weight Capacity", value: "Up to 30 kg per rod (High Strength)" },
      { label: "Durability", value: "5+ Years (Rust-Proof Stainless Steel)" },
  ...
  "balcony-cloth-hangers": {
    ...
    category: "cloth-hangers",
    categoryName: "Cloth Hangers",
    title: "Wall-Mounted & Railing Balcony drying Hangers Chennai | Aegis Nets - Safety Nets & Invisible Grills Chennai",
    ...
    aiOverview: "Aegis Balcony Cloth Hangers provide space-efficient drying using wall-mounted accordion grids or railing hooks. Built with rustproof coated steel, they collapse flat to keep balcony spaces clean.",
    ...
    specsTable: [
      ...
      { label: "Weight Capacity", value: "Up to 25 kg distributed load" },
      { label: "Durability", value: "5+ Years (Corrosion-Resistant)" },
