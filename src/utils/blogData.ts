  ...
  "invisible-grill-cost-chennai": {
    ...
    contentBlocks: [
      ...
      },
      {
        ...
        text: "While traditional iron grills are heavy, block fresh air, and require recurring painting to combat rust, Aegis invisible grills require zero painting. The thin steel wires are sleeved in clear nylon, preserving your view while providing safety barriers that support high load weights.",
      },
    ],
    faqs: [
      {
    ...
    faqs: [
      {
        ...
        answer: "Aegis recommends a 35mm to 50mm mesh size safety net. This is tight enough to prevent child hands and feet from climbing, while remaining highly tensioned.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer: "No. Aegis's bird nets act as a physical barrier. They prevent birds from entering nesting zones, directing them to open natural habitats without causing harm.",
      },
      {
