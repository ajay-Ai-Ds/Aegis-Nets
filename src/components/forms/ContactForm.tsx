...
const servicesList = [
  ...
  { value: "industrial-safety-nets", label: "Industrial Safety Nets" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 mt-2">
              ...
              >
                <div className="p-3 bg-orange-50 text-accent-orange rounded-xl shrink-0 group-hover:bg-accent-orange hover:bg-accent-hover group-hover:text-white transition-colors duration-300">
            ...
            {status === "success" ? (
              ...
              >
                ...
                <p className="text-slate-500 text-sm max-w-md leading-relaxed">
                  Thank you for reaching out to Aegis Nets. Our team will contact you shortly to schedule your free site measurement and share quotation details.
                </p>
                <button
