...
export default function ServiceAreas() {
  return (
    <section className="bg-[#F7F5F0] py-24 scroll-mt-12" id="areas">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="lg:col-span-1 flex flex-col gap-5 text-left">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              We provide prompt, on-site measurements and safety net installations across all major residential zones, commercial complexes, and apartments in Chennai.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {chennaiAreas.map((area, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-2.5 p-3.5 bg-[#F7F5F0] hover:bg-orange-50/50 hover:border-accent-orange/30 border border-slate-100 rounded-xl transition-all group cursor-default"
                >
