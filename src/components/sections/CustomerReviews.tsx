    ...
    <section className="bg-white py-24 scroll-mt-12" id="reviews">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-2xl mx-auto bg-[#F7F5F0] rounded-3xl p-8 sm:p-12 border border-dashed border-slate-300 text-center flex flex-col items-center gap-5"
        >
          ...
          <p className="text-xs text-slate-500 leading-relaxed max-w-md">
            This section is reserved for real reviews from Aegis Nets customer database. Ratings and testimonials will be populated as soon as verified client logs are shared.
          </p>
        </motion.div>
      </div>
    </section>
